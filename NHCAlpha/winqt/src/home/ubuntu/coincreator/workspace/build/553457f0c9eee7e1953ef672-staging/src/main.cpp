...
uint256 hashGenesisBlock("0xbcfd1c15132d4c71f37961f443eef2d87707e79fcf030bf3d6a24d9938888e7c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // NightHawkCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "NightHawkCoin Signed Message:\n";
...
{
    // NightHawkCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // NightHawkCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // NightHawkCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // NightHawkCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbcfd1c15132d4c71f37961f443eef2d87707e79fcf030bf3d6a24d9938888e7c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1422700501;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085212329;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NightHawkCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NightHawkCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running NightHawkCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("NightHawkCoinMiner terminated\n");
        throw;
    }
}
